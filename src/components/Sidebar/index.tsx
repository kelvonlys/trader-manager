...
>
  <path
    fillRule="evenodd"
    clipRule="evenodd"
    d="M12 4v8H4V4h8zm0 8h8V4H4v8zm0-4h8V4H4v8zm4-4h8V4H8v8zm0 4h8v-8H4v8zm8-4v8h-8V4h8zm0 4h-8v8h8zm0-4h-8V4h8zm4 4h8v-8h-8v8zm0 4h-8v-8h8zm0-4h-8V4h8zm4 4h8v-8h-8v8zm0 4h-8v-8h8zm0-4h-8V4h8zm4-4h8v-8h-8v8zm0 4h-8v-8h8z"
    fill="currentColor"
  />
</svg>
