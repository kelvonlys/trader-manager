...
const menuGroups = [
    ...
    menuItems: [
      {
        icon: (
          <Image
            src="/images/instruments/watchlist.svg"
            alt="My Icon"
            width={28}
            height={28}
      ...
      },
      {
        icon: (
          <Image
            src="/images/instruments/portfolio.svg"
            alt="My Icon"
            width={28}
            height={28}
            className="fill-current"
        ...
        route: "/opening-positions",
      },
      {
        icon: (
          <Image
            src="/images/instruments/pending-order.svg"
            alt="My Icon"
            width={28}
            height={28}
            className="fill-current"
      ...
      ////////// Below is strategy page /////////////
      // {
      //   icon: (
      //     <Image
      //       src="/images/instruments/break-even.svg"
      //       alt="My Icon"
      //       width={28}
      //       height={28}
      //       className="fill-current"
      //     />
      //   ),
      //   label: "Break-even Strategies",
      //   route: "/strategies",
      // },
      {
        icon: (
          <Image
            src="/images/instruments/bar-chart.svg"
            alt="My Icon"
            width={28}
            height={28}
            className="fill-current"
      ...
      ////////// Below is trading-bot page /////////////
      // {
      //   icon: (
      //     <Image
      //       src="/images/instruments/trading-bot.svg"
      //       alt="My Icon"
      //       width={28}
      //       height={28}
      //       className="fill-current"
  ...
  /* Below are leave out here as a template for future use */
  // {
  //   name: "OTHERS",
  //   menuItems: [
  //     {
